...
public class Proj7RuntimeMonitor extends RuntimeMonitor {
    ...
    SimTime doorReversalTime = SimTime.ZERO;
    ...
    protected String[] summarize() {
        ...
        arr[2] = "Total Door Reversals Process Time = " + doorReversalTime;
        return arr;
    }
    ...
    private void doorReopening(Hallway hallway) {
    	...
    	if(!stopWatch.isRunning()) {
    		message("Door reopens, stop watch starts.");
    		stopWatch.start();
    	}
    }
    ...
    private void doorClosed(Hallway hallway) {
        ...
        if (!doorState.anyDoorOpen()) {
            ...
            if (stopWatch.isRunning()) {
            	message("stop watch stops");
            	stopWatch.stop();
            	doorReversalTime = stopWatch.getAccumulatedTime();
            }
        }
    }
